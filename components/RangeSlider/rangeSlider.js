...
class Slider extends Component {
    ...
    handleUpdate = () => {
        ...
        const dimension = capitalize(constants.orientation[orientation].dimension)//'width'
     ...
     */
    coordinates = (pos) => {
        let fillPos = null, limitPos = null
    ...
    render() {
        ...
        const reversefillStyle = {[dimension]: `${coords.reversefill}px`}
        ...
        return (
            <div
                ...
                <div
                    ...
                    style={fillStyle}
                />
                <div className='rangeslider__inverse' style={reversefillStyle}/>
                <div
